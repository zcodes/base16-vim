" vi:syntax=vim
" Vim color schemes base on base16
" Maintainer: zcodes <zcodes@qq.com>
"
" The theme file original borrowed from "vim-tomorrow-theme".
" See https://github.com/chriskempson/vim-tomorrow-theme.git for it.
"
" The hex functions borrowed from theme "desert256".
" See https://github.com/vim-scripts/desert256.vim/blob/master/colors/desert256.vim
"
" The theme file is generated by "builder.php", origin from "base16-build-php".
" See https://github.com/chriskempson/base16-builder-php
"
" Atelier Heath Light scheme by Bram de Haan (http://atelierbramdehaan.nl)

" Default GUI colors
let s:foreground = '695d69'
let s:background = 'f7f3f7'
let s:selection = 'ab9bab'
let s:line = 'd8cad8'
let s:comment = '9e8f9e'
let s:red = 'ca402b'
let s:orange = 'a65926'
let s:yellow = 'bb8a35'
let s:green = '918b3b'
